...
import {
  ...
  APP_SECTION, CTA_SECTION, CONTACT_HERO, CONTACT_PAGE_INFO, CHANNELS,
...
import { APP_LINKS_DEFAULTS, DEFAULT_FOOTER_COLUMNS, SITE_CONTACT_INFO, PLATFORM_LINKS, WORK_HOURS } from "../app/lib/dashboard/placeholders";
...
async function main() {
  ...
  await prisma.contactPage.create({ data: { id: "CONTACT", hero: CONTACT_HERO as any, contactInfo: CONTACT_PAGE_INFO as any, channels: CHANNELS as any, inquiryOptions: INQUIRY_OPTIONS as any, successMessage: SUCCESS_MESSAGE_DEFAULT, formFields: FORM_FIELDS_DEFAULTS as any } });
  ...
  await prisma.siteSettings.create({ data: { id: "SETTINGS", siteTitle: SITE_SETTINGS.siteTitle, siteDescription: SITE_SETTINGS.siteDescription, faviconUrl: SITE_SETTINGS.faviconUrl, seoKeywords: SITE_SETTINGS.seoKeywords, navLinks: NAV_LINKS as any, socialLinks: SOCIAL_LINKS as any, appLinks: APP_LINKS_DEFAULTS as any, footerColumns: DEFAULT_FOOTER_COLUMNS as any, contactInfo: SITE_CONTACT_INFO as any, platformLinks: PLATFORM_LINKS as any, workHours: WORK_HOURS as any } });
