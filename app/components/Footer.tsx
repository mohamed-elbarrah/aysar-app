...
const appLinks = [
  { label: "App Store", href: "https://apps.apple.com/sa/app/%D8%A3%D9%8A%D8%B3-%D8%B1/id6746420561?l=ar&platform=iphone", external: true },
  { label: "Google Play", href: "https://play.google.com/store/apps/details?id=com.aysar.application", external: true },
];

const socialLinks = [
  { label: "واتساب", href: "https://wa.me/966125101107", icon: WhatsAppIcon },
  { label: "X", href: "https://x.com/aysar_ksa", icon: XIcon },
  { label: "إنستغرام", href: "https://www.instagram.com/aysar_ksa/", icon: InstagramIcon },
  { label: "تيك توك", href: "https://www.tiktok.com/@aysar_sa", icon: TikTokIcon },
];
