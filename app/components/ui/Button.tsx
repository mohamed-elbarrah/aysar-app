...
type ButtonVariant = "primary" | "secondary" | "ghost" | "solid" | "cta" | "whatsapp";
...
interface ButtonAsAnchorProps extends ButtonBaseProps, Omit<AnchorHTMLAttributes<HTMLAnchorElement>, "children"> {
  href: string;
  children: ReactNode;
}
...
export function Button({
  ...
  const sizeStyles: Record<ButtonSize, string> = {
    sm: "text-[13px] px-5 py-2 rounded-[9px]",
    md: "text-[15px] px-8 py-3.5 rounded-[11px]",
    lg: "text-base px-10 py-4 rounded-[13px]",
  };
